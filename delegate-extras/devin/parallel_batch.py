...
# Import the delegate runner via the bundled subprocess shim (the ~70KB core
# delegate.py does not travel into delegate-extras/; the shim shells out to the
# installed devin-delegate wrapper instead).
try:
    from delegate_shim import run_delegate
except ImportError:
